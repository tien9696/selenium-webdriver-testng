...
public class Topic_13_Frame_Windown {
	...
	public void TC_01_ID() {
		...
		String like = driver
				.findElement(By.xpath("//img[@alt='Khóa học online nâng cao kỹ năng cùng các chuyên gia đầu ngành']"))
				.getText();
		System.out.println();

		driver.switchTo().frame(driver.findElement(By.xpath("//iframe[@id='cs_chat_iframe']")));
		// driver.findElement(By.xpath("//label[text()='0 new
		// messages']//parent::div//parent::div[@class='button_text']//following-sibling::div[@class='blinds
		// blinds_top']")).click();
		...
		driver.findElement(By.xpath(
				"//label[contains(text(),'Nhập thông tin của bạn')] //following-sibling::input[@placeholder='Nhập tên của bạn']"))
				.sendKeys("automation");

		driver.findElement(By.xpath(
				"//label[contains(text(),'Nhập thông tin của bạn')] //following-sibling::input[@placeholder='Nhập số điện thoại của bạn']"))
				.sendKeys("09123456");

		// driver.findElement(By.xpath("//label[text()='Chọn dịch vụ hỗ trợ']
		// //parent::label//following-sibling::select")).click();
		driver.findElement(By.xpath("//textarea[@name='message']")).sendKeys("automation boottrap");

		driver.switchTo().defaultContent();

		driver.findElement(By.xpath(
				"//label[text()='Tìm kiếm']//following-sibling::input[@placeholder='Nhập tên khóa học/giảng viên']"))
				.sendKeys("excel");
		driver.findElement(By.xpath("//button[@aria-label='search']")).click();
		List<WebElement> allexcel = driver.findElements(By.xpath("//h4[contains(text(),'Excel')]"));
		// List<WebElement> allexcel =
		// driver.findElements(By.cssSelector(".content>h4"));
	...
	public void TC_02_Window_tab() {
		...
		Assert.assertTrue(
				driver.findElement(By.xpath("//input[@data-view-id='main_search_form_input']")).isDisplayed());
	...
	// switch to windowbyTitle:
	public void switchToWindowByTitle2(String tabTitle) {
		//get all title
